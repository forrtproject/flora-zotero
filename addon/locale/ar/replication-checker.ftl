...
replication-checker-add-original-batch-success = تمت إضافة { $newCount } جديد/جديدة وتحديث { $existingCount } دراسة/دراسات أصلية موجودة في "{ $folderName }".
replication-checker-add-original-batch-new-only = تمت إضافة { $count } دراسة/دراسات أصلية بنجاح إلى "{ $folderName }".
replication-checker-add-original-batch-exists-only = { $count } دراسة/دراسات أصلية موجودة بالفعل في مكتبتك — تم تحديث العلامات والملاحظات والعلاقات في "{ $folderName }".
...
replication-checker-notif-replication-new = تمت إضافة { $count } تكرار/تكرارات جديدة بنجاح إلى "{ $folderName }".
replication-checker-notif-replication-exists = { $count } تكرار/تكرارات موجودة بالفعل في مكتبتك — تم تحديث العلامات والملاحظات والعلاقات في "{ $folderName }".
replication-checker-notif-replication-mixed = تمت إضافة { $newCount } جديد/جديدة وتحديث { $existingCount } تكرار/تكرارات موجودة في "{ $folderName }".
...
replication-checker-dialog-is-replication-message =
    لم يتم العثور على تكرارات، لكن يبدو أن هذا دراسة تكرار.
    تم العثور على { $count } مقالة/مقالات أصلية.

    هل تريد إضافتها إلى مكتبتك؟
...
replication-checker-results-found = { $count } عنصر/عناصر لديها تكرارات، مخزّنة في "{ $folderName }".
replication-checker-results-none = لم يتم العثور على تكرارات.
replication-checker-results-reproductions-found = { $count } عنصر/عناصر لديها استنساخات، مخزّنة في "{ $folderName }".
...
pref-stats-fetch-result = وجد FLoRA { $matchedCount } من { $origCount } مقالة/مقالات أصلية.
pref-stats-fetch-breakdown = الإجمالي المعروف: { $repCount } تكرار/تكرارات و{ $reproCount } استنساخ/استنساخات في تلك المقالات.
